...
- `/NFT/` - Procedural generation, simulation, sprite pairing, &c. of various things.
- `/popups/` - Collection of popups with main `tester.html` doing a showcase of how to use it. Will be integrated into other dirs when applicable.
...
4. Make the LaTeX papers I've written availible in a dir here. Latex to html?
5. Copy over my aops blog lol

------
<details>
<summary>How the Custum Workflow Works</summary>
